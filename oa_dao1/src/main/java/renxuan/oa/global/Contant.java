...
public class Contant {
	...
	//items
	public static final String ITEM_TRAFFIC="交通";
	public static final String ITEM_FOOD="餐饮";
	public static final String ITEM_ACCOMMODATION="住宿";
	public static final String ITEM_WORK="办公";
